	...
	function getCZ(JZnum){
		...
		switch (curJZnum) {
			...
			case 4:
				...
				break;
			case 5:
				CZname = new Array("白塘","山景","鲍宅","后张","张家","吴村","陇头朱","西田","青肃","上宅","车路","上滕","下店","下滕","先田","西楼","缸窑","何店","前屋","上胡","叶前","枧畴","杭畴","古亭塘","龙华院","雅文楼","石塔一","石塔二","王阡","王莲塘","铜山前","白塔塘","畈田朱","早溪塘","包西塘","铜山湖","江岸","五联","陈家（农村居委会）","义亭（农村居委会）","荷店塘（农村居委会）","旺吴桥（农村居委会）","车站（农村居委会）"); 
				break;
			case 6:
				CZname = new Array("团结","杜桥","红旗","凰升塘","北金山","大陈一村","大陈二村","大陈三村","朝塘","婆姆","西岸","善坑","马畈","春林","溪后","大畈","楂林一村","楂林二村","李孟宅","上坑仁","大岭下","杜门","红峰","宦塘","义北","灯塔","东联","北山府","立山黄","八里桥头","众拥","后畈（农村居委会）");
				break;
			case 7:
			...
			case 10:
				...
				break;
			case 11:
				CZname = new Array("深塘","李宅","埠头","何宅","后义","陶店","王店","东莲塘","葛塘","张思","派塘","西澄","华溪","联五","里兆","西京","李塘","泉塘","大岭","里忠","群益","塘下店","郑山头","下朱宅","张家园","活鱼塘","楼山塘","屏石头","后乐（农村居委会）","东陈（农村居委会）");
				break;
			case 12:
				CZname = new Array("全备","寺前","洪家","后余","上周","李祖","岭脚","下万","陈宅","大傅宅","岩南","上金","苏街","吴宅","下旺","俊塘","坞灶","广口","湖门","新华","后毛店","马踏石","马交塘","西关田","深塘下","方塘","稠岩","余店","金鹤","前后傅","黄龙（农村居委会）","宅二（农村居委会）");
				break;
			case 13:
